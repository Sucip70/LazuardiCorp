  ...
  // ─── Forms ────────────────────────────────────────────────
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'Live display, e.g. {{result}}. Overrides default when set.',
      },
      {
        key: 'bindToVar',
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'On change, writes the typed value into this variable (e.g. a).',
      },
      {
        key: 'bindScope',
        label: 'Bind scope',
  ...
  },
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'Live display, e.g. {{result}}.',
      },
      {
        key: 'bindToVar',
        label: 'Bind to variable',
        type: 'text',
        group: 'behavior',
        helpText: 'On change, writes into this variable.',
      },
      {
        key: 'bindScope',
        label: 'Bind scope',
  ...
  },
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'Live selection, e.g. {{choice}}.',
      },
      {
        key: 'bindToVar',
        label: 'Bind to variable',
