...
export const COMPONENT_CATALOG: ComponentCatalogEntry[] = [
  ...
  },
  {
    ...
    editableFields: [
      { key: 'name', label: 'Icon name', type: 'select', group: 'content', options: [
        { label: 'Info', value: 'info' }, { label: 'Check', value: 'check' }, { label: 'Warning', value: 'warning' }, { label: 'Search', value: 'search' },
      ]},
  ...
  // ─── Forms ────────────────────────────────────────────────
  {
    ...
    icon: '▭',
    acceptsChildren: false,
    defaultProps: { name: 'field', label: 'Label', inputType: 'text', placeholder: '', required: false, helperText: '' },
    defaultStyles: { className: 'w-full' },
    editableFields: [
      { key: 'label', label: 'Label', type: 'text', group: 'content', required: true },
  ...
  },
  {
    ...
    icon: '▤',
    acceptsChildren: false,
    defaultProps: { name: 'message', label: 'Message', rows: 4, placeholder: '', required: false },
    defaultStyles: { className: 'w-full' },
    editableFields: [
      { key: 'label', label: 'Label', type: 'text', group: 'content', required: true },
      { key: 'name', label: 'Field name', type: 'text', group: 'behavior', required: true },
