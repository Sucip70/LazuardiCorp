  ...
  // ─── Forms ────────────────────────────────────────────────
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'One-way display only, e.g. {{output}}. For editable inputs leave empty — use this component id.value in Math.',
      },
      {
        key: 'bindToVar',
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'Output only: display a named variable (e.g. output). Makes the field read-only. Typed values use componentId.value instead.',
      },
      {
        key: 'bindScope',
        label: 'Bind scope',
  ...
  },
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'One-way display only, e.g. {{output}}. Leave empty for editable fields — use componentId.value in Math.',
      },
      {
        key: 'bindToVar',
        label: 'Bind to variable',
        type: 'text',
        group: 'behavior',
        helpText: 'Output only: display a named variable. Makes the field read-only.',
      },
      {
        key: 'bindScope',
        label: 'Bind scope',
  ...
  },
  {
    ...
    editableFields: [
      ...
      { key: 'defaultValue', label: 'Default value', type: 'text', group: 'content' },
      {
        ...
        type: 'text',
        group: 'behavior',
        helpText: 'One-way display only, e.g. {{choice}}. Leave empty for editable selects — use componentId.value in Math.',
      },
      {
        key: 'bindToVar',
        label: 'Bind to variable',
        type: 'text',
        group: 'behavior',
        helpText: 'Output only: display a named variable. Disables the select.',
      },
      {
        key: 'bindScope',
        label: 'Bind scope',
